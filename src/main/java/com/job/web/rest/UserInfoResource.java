...
/**
 * REST controller for managing {@link com.job.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
public class UserInfoResource {
    ...
    public ResponseEntity<List<UserInfo>> getAllUserInfos(UserInfoCriteria criteria, Pageable pageable) {
